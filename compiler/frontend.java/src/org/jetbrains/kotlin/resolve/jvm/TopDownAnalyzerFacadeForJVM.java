...
public enum TopDownAnalyzerFacadeForJVM {
    ...
    private static AnalysisResult analyzeFilesWithJavaIntegration(
        ...
        try {
            ...
            Collection<AnalyzeCompleteHandlerExtension> analyzeCompleteHandlerExtensions =
                    AnalyzeCompleteHandlerExtension.Companion.getInstances(moduleContext.getProject());

            for (AnalyzeCompleteHandlerExtension extension : analyzeCompleteHandlerExtensions) {
                extension.handleAnalyzeResult(project, module, bindingContext, files);
            }
