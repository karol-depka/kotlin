...
public trait ResolutionFacade {
    ...
    companion object {
        //NOTE: idea default API returns module search scope for file under module not in source or production source
        // this scope can't be used search for kotlin declarations in index in order to resolve in that case
